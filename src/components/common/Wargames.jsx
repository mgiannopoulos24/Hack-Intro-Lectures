    ...
    <>
      ...
      <div className="wg-content">
        ...
        <Tabs
          ...
          centered
          id="wg-tabs"
          sx={{ '& .MuiTabs-indicator': { backgroundColor: '#b5e853' } }}
        >
        ...
        {value === 0 && (
          <div className="wg-cards">
            <Link
              to="https://overthewire.org/wargames/narnia/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={otw_img} title="Narnia" description="Binary Exploitation" />
            </Link>
            <Link
              to="https://overthewire.org/wargames/behemoth/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={otw_img} title="Behemoth" description="Binary Exploitation" />
            </Link>
            <Link
              to="https://overthewire.org/wargames/maze/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={otw_img} title="Maze" description="Binary Exploitation" />
            </Link>
            <Link
              ...
              rel="noopener noreferrer"
            >
              <TiltCard image={otw_img} title="Leviathan" description="Binary Exploitation" />
            </Link>
            <Link
              to="https://overthewire.org/wargames/utumno/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={otw_img} title="Otumno" description="Binary Exploitation" />
            </Link>
            <Link
              to="https://www.smashthestack.org/blowfish.html"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={sts_img} title="Blowfish" description="Binary Exploitation" />
            </Link>
            <Link
              to="https://play.picoctf.org/practice?category=1"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={pico_img} title="PicoCTF" description="Web Exploitation" />
            </Link>
            <Link
              to="https://play.picoctf.org/practice?category=2"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={pico_img} title="PicoCTF" description="Cryptography" />
            </Link>
            <Link
              to="https://play.picoctf.org/practice?category=3"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={pico_img} title="PicoCTF" description="Reverse Engineering" />
            </Link>
            <Link
              to="https://play.picoctf.org/practice?category=4"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={pico_img} title="PicoCTF" description="Forensics" />
            </Link>
            <Link
              to="https://play.picoctf.org/practice?category=5"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={pico_img} title="PicoCTF" description="General Skills" />
            </Link>
            <Link
              to="https://play.picoctf.org/practice?category=6"
              target="_blank"
              rel="noopener noreferrer"
            >
              <TiltCard image={pico_img} title="PicoCTF" description="Binary Exploitation" />
            </Link>
          </div>
        )}
        {value === 1 && (
